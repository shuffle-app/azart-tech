...
const Product = () => {
...

    {
      ...
      cards: [
        ...
        },
        {
          ...
          cardDesc:
            'making an economic/conversion forecast product concept on three levels: optimistic, optimal, pessimistic. Based on the potential of digital tools.',
        },
        {
...

    {
      ...
      cards: [
        ...
        },
        {
          ...
          cardDesc:
            'alas, we cannot silently accept your idea and put it into operation until we examine the target market, taking apart its strengths and weaknesses into grains in order to improve your concept to a unique level',
        },
        {
  ...
  return (
    <section className={` ${s.product_section}`} id="services">
      <h1>Product</h1>
            ...
            <div className={s.product_header}>
              ...
              <button onClick={() => onClickCard(index)} className={s.list_btn}>
                {activeProductIndex === index ? (
                  <img
                    className={s.btn}
                    src="./assets/icons/arr-minus.svg"
                    alt="btn"
                    width="30"
                    height="30"
                  />
