        ...
        <section className={`${s.team_section}`}>
            <div className='container'>
                <div className={s.header}>
                    <h1>Team</h1>
                    <p>when it comes to the team, there can be no exceptions. Only the best remain. Competence + productivity + punctuality + honesty = azart.tech</p>
                    <div>
            ...
            <div className='container'>
                <div className={s.download_block}>
                    <p className={s.text}>Fill out the feedback form and get a useful bonus to your work</p>
