        ...
        <div className={s.quiz_blocks}>
          ...
          {step === 6 && (
            <div className={s.from_block}>
              <div className={t.form_header} style={{ padding: 30 }}>
                ...
                >
                  On the next page, we are already waiting for a promo code for
                  7 free hours of interaction with the team. To receive, leave
          ...
          {step === 7 && (
            <div className={s.promocode_block}>
              ...
              <div className={s.promocode_text}>AZARTIES</div>

              <hr className={s.separator} />
              <img
                className={s.gift}
                src="./assets/img/gift_front.svg"
                alt=""
              />
              <div className={s.promo_btns}>
                <a
                  className="promo_btn"
                  href="/assets/files/promocode.pdf"
                  download
                >
                ...
                <button
                  className="promo_btn"
                  onClick={() => {
                    navigator.clipboard.writeText('AZARTIES');
                  }}
                >
                  Copy to Clipboard
                </button>
