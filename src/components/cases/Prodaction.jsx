                ...
                <section className="container">
                    ...
                    <div className={s.promo_block}>
                        <div className={s.promo_video}>
                                <p>{cases.promoVideo1} <br /><span>{cases.promoVideo2}</span></p>
                                
                            <img src="./assets/img/914.png" alt="" />
                        </div>
                        <div className={s.download}>
                            <h3>Download pitch presentation</h3>
                            <p>We have developed a product presentation material for investors and partners (download by button)</p>
