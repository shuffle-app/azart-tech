            ...
            <section className="container">
                <section className={` ${s.bm_section}`}>
                    <div className={s.text_content}>
                        ...
                        <p className={s.p} >Here are collected cases on various topics. We specialize not only in IT, but also in other similar areas</p>
                        <div>
                ...
                <section className={s.mobile_card}>
                    <div className={c.card}>
                        ...
                        <div className={c.card_text}>
                            <h4>Shuffle<span>start-up</span></h4>
                            <p>an honest and unique application that will suggest you find places, people, food, entertainment, etc.</p>
                        </div>
