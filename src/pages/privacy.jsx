  ...
  return (
    <>
      ...
      <div className={styles.page}>
        ...
        <p>
          This privacy policy concerns the processing of personal data by
          azarties.com (&ldquo;Public Website&rdquo;).
        </p>

        <p>Our contact information is:</p>

        <p>
          Dubai Silicon Oasis, DDP, Building A2, Dubai, UAE IFZA Business park
          Premises number 23963 - 001 Makani number A2 - 3645879076 License
          number 23963 General manager phone number +971585025388 Email:
          privacy@azarties.com
        </p>

        <p>
          This Privacy Policy describes Our policies and procedures on the
          collection, use and disclosure of Your information when You use the
          Service. We use Your Personal data to provide and improve the Service.
        ...
        <p>
          ...
          time the browser requests a page from the server. Cookies do not
        ...
        <p>
          We use cookies for the following purposes: authentication &ndash; we
          use cookies to identify you when you visit our website and as you
          navigate our website; analysis &ndash; we use cookies to help us to
          analyze the use and performance of our website.
        </p>

        <h2>Use of Your Personal</h2>
        <p>
          Data We will retain collected personal data for as long as is
          necessary to provide you with the requested service unless alonger
          retention period is required by law.
        </p>

        <p>
          We take adequate measures to protect your data from being stolen,
          lost, or used in any way that is not in line with thepurposes for
        ...
        <p>
          &bull; To provide and maintain our Service, including to monitor the
          usage of our Service.
        </p>

        <p>
          &bull; To manage Your Account: to manage Your registration as a user
        ...
        <p>
          &bull; For the performance of a contract: the development, compliance
        ...
        <p>
          &bull; To contact You: To contact You by email, telephone calls, SMS,
        ...
        <p>
          &bull; To provide You with news, special offers and general
        ...
        <p>
          &bull; To manage Your requests: To attend and manage Your requests to
          Us. We may share your personal information in the following
          situations: &bull; With Service Providers:
        </p>
        ...
        <p>
          &bull; For Business transfers: We may share or transfer Your personal
        ...
        <p>
          &bull; With Affiliates: We may share Your information with Our
          affiliates, in which case we will require those affiliates to honor
          this Privacy Policy.
        </p>

        <p>
          &bull; With Business partners: We may share Your information with Our
          business partners to offer You certain products, services or
          promotions.
        </p>

        <p>
          &bull; With other users: when You share personal information or
        ...
        <h2>Transfer of Your Personal</h2>
        <p>
          Data Your information, including Personal Data, is processed at the
        ...
        <p>
          &bull; Prevent or investigate possible wrongdoing in connection with
          the Service
        </p>

        <p>
          &bull; Protect the personal safety of Users of the Service or the
          public &bull; Protect against legal liability{' '}
        </p>
